...
class Student 
{
  ...
  public function addStudent($name,$surname,$sidiCode,$taxCode){
    ...
    //curl --header "Content-Type: application/json" --request POST --data {"""_name""":"""nameBello""","""_surname""":"""surnameBello""","""_sidiCode""":"""23233444""","""_taxCode""":"""RJDIJEIJWEJ9FDIEF"""} http://localhost:8000/student.php
    $stmt = $this->db->prepare($sql);
    $data = [
      //'id' => $id,
      'name' => $name,
  ...
  // curl --header "Content-Type: application/json" --request DELETE --data {"""_id""":67} http://localhost:8000/student.php
  ...
  //curl --header "Content-Type: application/json" --request PUT --data {"""_id""":64,"""_name""":"""nameModificato""","""_surname""":"""surnameModificato""","""_sidiCode""":"""11111111""","""_taxCode""":"""22r9dewodm3"""} http://localhost:8000/student.php
